...
train_csv = 'Data/MedMCQA/train_for_mcq_w_no_exp_qa.csv'
...
for epoch in range(epochs):
    ...
    train_stats_df.to_csv("mcq_w_no_exp_qa_gpt2_finetuning.csv")
    
    if epoch == 0:
        best_val_loss = epoch_val_loss
    
    if epoch_val_loss <= best_val_loss:
        torch.save(model.state_dict(), 'mcq_w_no_exp_qa_gpt2_finetuned_'+str(epoch)+'.pth')
        best_val_loss = epoch_val_loss
